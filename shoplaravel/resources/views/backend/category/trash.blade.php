          ...
          <table class="table table-striped table-bordered">
            <thead>
                <tr class="bg-info">
                    ...
                    <th>Tên danh mục</th>
                    <th style='width:80px;height:70px'>Logo</th>
                    <th>Slug</th>
                    <th>Ngày tạo</th>
                    <th>Chức năng</th>
                    <th>ID</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route ('category.restore',['category'=>$category->id]) }}" class="btn btn-sm btn-info"><i class="far fa-eye"></i> </a>
                        <!-- <a href="{{ route ('category.edit',['category'=>$category->id]) }}" class="btn btn-sm btn-primary"><i class="far fa-edit"></i>  </a> -->
                        <a href="{{ route ('category.destroy',['category'=>$category->id]) }}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i>  </a>
                    </td>
                    <td>{{$category->id}}</td>
                </tr>
                @endforeach
